...
export default class Profile extends Component {
	state = {
		...
		summaryInformation:
			'Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga ipsum deserunt in sint saepe corporis ad tempora illo nobis praesentium minima ipsam, vitae neque soluta pariatur, quibusdam officiis dolorem!',
		workExperience: [
			{
		...
		education: [
			{
				...
				description:
					'Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum fuga ipsum deserunt in sint saepe corporis ad tempora illo nobis praesentium.',
				date: '11/01/2011'
			},
			{
		...
		return (
			<div id="profile-wrapper" className="container">
				...
				<div id="profile-aside">
					<GeneralSection
						sectionClass="social-networks"
						icon="globe"
						headerCopy="Social Networks"
					>
					...
					<GeneralSection
						...
						icon="language"
						headerCopy="Languages"
					>
						<Languages languages={this.state.languages} />
					</GeneralSection>
					<GeneralSection
						sectionClass="hobbies"
						icon="heart"
						headerCopy="Hobbies"
					>
